// ----------------------------------------------------------------------------
// Taken from Scriptable Framework
// Original Author: Ryan Hipple
// Date: 05/07/2018
// ----------------------------------------------------------------------------
...
namespace ZType.Core.Editors.Utility.SceneAsset
{
	/// <summary>
	/// Editor for a scene asset that can display error prompts and offer
	/// solutions when the scene is not valid.
	/// </summary>
	[CustomPropertyDrawer (typeof (ZType.Core.Utility.SceneAsset.SceneAsset))]
